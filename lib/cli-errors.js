...
(function (CliConfigErrorCategory) {
    ...
    CliConfigErrorCategory["UnsupportedPlatform"] = "UnsupportedPlatform";
...
exports.cliErrorsConfig = {
    ...
    [CliConfigErrorCategory.UnsupportedPlatform]: {
        ...
        additionalErrorMessageToAppend: `This platform/arch combination (${process.platform}/${process.arch}) is not supported by the CodeQL CLI. See https://codeql.github.com/docs/codeql-overview/system-requirements`,
    },
